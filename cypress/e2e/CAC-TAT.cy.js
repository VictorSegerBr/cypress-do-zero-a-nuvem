describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche os campos obrigatórios e envia o formulário', () => {
      ...
      cy.get('#open-text-area').type('Teste.Teste.Teste.Teste.Teste.', {delay:0})
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', () => {
      cy.get('#firstName').type('Primeiro').should('have.value', 'Primeiro')
      cy.get('#lastName').type('Último').should('have.value', 'Último')
      cy.get('#email').type('teste@teste.com').should('have.value', 'teste@teste.com')
      cy.get('#phone').type('41999999999').should('have.value', '41999999999')
